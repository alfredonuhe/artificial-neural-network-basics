...
# Create dataframes
entrenamiento_csv = read.csv("train.csv", header = FALSE, sep = ";", quote = "", dec = ",")
validacion_csv = read.csv("validation.csv", header = FALSE, sep = ";", quote = "", dec = ",")
...
# Write to files denormalized train, test and expected outputs
...
# Create output comparison graph
...
# Write train and validation error tables
...
# Write table with average train, test and validation errors
